...
1. ตัวละคร: สร้างตัวละคร **อย่างน้อย 4 คน แต่ไม่เกิน 6 คน** (ห้ามสร้างเพียง 3 คน) แต่ละคนต้องมี:
   - **ประวัติส่วนตัวที่ซับซ้อน**: อดีตที่เชื่อมโยงกับเหยื่อในระยะยาว (เดือน-ปี)
   - **ความลับหลายชั้น**: ไม่ใช่แค่ความลับเดียว แต่มีหลายความลับที่เกี่ยวเนื่องกัน
   - **แรงจูงใจทางจิตวิทยา**: ความโกรธ, ความอิจฉา, ความกลัว, ความรัก, การแก้แค้น ที่สะสมมานาน
   - **ความสัมพันธ์ที่เปลี่ยนแปลง**: มิตรภาพที่กลายเป็นศัตรูภาพ, ความรักที่กลายเป็นความเกลียด

2. **กลอุบายและการหลอกลวง (ต้องมีอย่างน้อย 3-4 กลอุบาย)**:
   - **การปลอมตัวตนระยะยาว**: แอบอ้างเป็นคนอื่น, ปลอมประวัติ, หรือซ่อนความจริงเป็นเดือน-ปี
   - **การใช้สิ่งแวดล้อมและเวลา**: ใช้เสียงธรรมชาติ (ฟ้าร้อง, ดนตรี, เครื่องจักร) ปิดบังเสียงการฆ่า
   - **การจัดการหลักฐานทางร่างกาย**: ใช้ความรู้ทางวิทยาศาสตร์ (Rigor mortis / การเกร็งตัวของกล้ามเนื้อ, อุณหภูมิศพ, การย่อยสลาย)
   - **การทำซ้ำวิธีฆาตกรรมเก่า**: เลียนแบบคดีเก่าเพื่อหลอกลวงหรือแก้แค้น
   - **การใช้ความไว้วางใจ**: หลอกให้เหยื่อเชื่อใจแล้วโจมตีในช่วงที่ประมาท
   - **การสร้างการฆ่าตัวตายปลอม**: จัดฉากให้ดูเหมือนเหยื่อฆ่าตัวตาย พร้อมเหตุผลที่น่าเชื่อ
   - **การใช้เทคโนโลยีหรือเครื่องมือพิเศษ**: อุปกรณ์ตั้งเวลา, เครื่องบันทึกเสียง, กล้องวงจรปิด
   - **การสร้างข้ออ้างปลอม**: ผู้กระทำผิดต้องสร้างข้ออ้างที่ดูน่าเชื่อถือ พร้อมพยานหรือหลักฐานสนับสนุน
   - **การโยนความผิดให้ผู้อื่น**: วางหลักฐานปลอมหรือจัดฉากให้คนอื่นดูเป็นผู้ต้องสงสัย
   - **การใช้ความรู้พิเศษ**: เช่น ความรู้ด้านเคมี การแพทย์ เทคโนโลยี เพื่อสร้างกลอุบาย

3. **แรงจูงใจที่ลึกซึ้งและซับซ้อน**:
   - **การแก้แค้นข้ามผ่านกาลเวลา**: เรื่องราวที่เกิดขึ้นหลายปีก่อน แล้วถูกกระตุ้นให้ลุกไหม้อีกครั้ง
   - **ความรักที่ผิดพลาด**: ความรักที่ไม่ได้รับการตอบรับ, การหักหลัง, การถูกทอดทิ้ง
   - **ความลับครอบครัว**: มรดก, การรับเลี้ยง, พันธุกรรม, เกียรติยศตระกูล
   - **อาชญากรรมในอดีต**: การปกปิดคดีเก่า, การฆาตกรรมที่ไม่ถูกแก้ไข, การยุติธรรมที่บิดเบือน
   - **การเงินและธุรกิจ**: หนี้สิน, การล้มละลาย, การถูกแบล็กเมล์, การคุกคาม
   
4. หลักฐาน: สร้าง 10-15 ชิ้นหลักฐาน แบ่งเป็น:
   - **หลักฐานทางกายภาพขั้นสูง (4-5 ชิ้น)**: ร่องรอยดีเอ็นเอ, ลายนิ้วมือที่ถูกปลอมแปลง, เครื่องมือฆาตกรรมที่ซับซ้อน
   - **หลักฐานทางจิตวิทยา (2-3 ชิ้น)**: จดหมาย, ไดอารี่, ข้อความที่เผยจิตใจ
   - **หลักฐานหลอกลวงขั้นสูง (3-4 ชิ้น)**: การสร้างข้ออ้างปลอมที่ซับซ้อน, พยานเท็จ, ข้อมูลปลอมแปลง
   - **หลักฐานเทคโนโลยี (2-3 ชิ้น)**: บันทึกการโทร, ข้อมูลดิจิทัล, กล้องวงจรปิด, GPS

5. ความสัมพันธ์: ตัวละครต้องมีความสัมพันธ์ที่ซับซ้อนและขัดแย้งกัน รวมถึงการมีศัตรูหลายคน เพื่อให้ผู้กระทำผิดมีตัวเลือกในการโยนความผิด
...

{
    "situation": {
        ...
        "victim": "คุณสมชาย ธนาคาร", // ชื่อเหยื่อ
        "age": "45",
    ...
    "evidence": [
        // สร้างหลักฐาน 10-15 ชิ้น โดยแบ่งประเภทตามความสำคัญ
        {
            ...
            "connection": "", // การเชื่อมโยงกับหลักฐานอื่นหรือตัวละคร,
...
- ต้องมีหลักฐานหลอกลวงที่ดูน่าเชื่อถือมากและทำให้ผู้เล่นเข้าใจผิด
- ตัวละครแต่ละคนต้องมีแรงจูงใจที่เข้าใจได้ และมีเหตุผลที่จะเป็นผู้ต้องสงสัยได้
- การแก้ปริศนาต้องอาศัยการวิเคราะห์หลักฐานและการสอบสวนตัวละครอย่างละเอียด
- **ผู้กระทำผิดต้องดูเป็นผู้ต้องสงสัยน้อยที่สุดในตอนแรก** เพื่อสร้างความประหลาดใจ
- กลอุบายต้องสมเหตุสมผลและสามารถทำได้จริง แต่ต้องชาญฉลาดและซับซ้อน
- ต้องมีการใช้จิตวิทยาในการหลอกลวง เช่น การเล่นกับอคติและความคาดหวังของผู้สืบสวน

ส่วน description ใน resolution ต้องมีรายละเอียดครบถ้วน ประกอบด้วย:
- แรงจูงใจ: เหตุผลที่ชัดเจนและน่าเชื่อ รวมถึงความสัมพันธ์ที่ซับซ้อนกับเหยื่อ อาจะเป็นแรงจูงใจทางจิตวิทยาที่ลึกซึ้ง
- การวางแผน: ระยะเวลาและการศึกษาข้อมูลล่วงหน้า รวมถึงการวิเคราะห์จุดอ่อนของเหยื่อและคนอื่นๆ
- **กลอุบายและการหลอกลวง**: อธิบายรายละเอียดกลวิธีที่ใช้ เช่น:
  - วิธีการสร้างข้ออ้างปลอมและพยานเท็จ
  - การโยนความผิดให้ผู้อื่นอย่างไรบ้าง (ใครบ้าง ทำไม เอาหลักฐานอะไรไปวาง)
  - การใช้เวลาหลอกลวง (ถ้ามี)
  - การใช้ตัวแทนหรือเครื่องมือ (ถ้ามี)
- การเตรียมการ: ขั้นตอนการหาอาวุธ/เครื่องมือ การเตรียมหลักฐานปลอม และการเตรียมการอื่นๆ
- กระบวนการฆาตกรรม: เวลาที่แน่นอน, วิธีการฆ่าทีละขั้นตอน, ระยะเวลาที่ใช้ หรือ ลำดับเวลาของเหตุการณ์ที่แท้จริง
- การดำเนินการหลังฆ่า: การจัดฉาก การวางหลักฐานปลอม การสร้างข้ออ้างปลอม
...
**หลักการสำคัญสำหรับนิยายสืบสวนขั้นสูง:**

1. **ความลึกของตัวละคร**: แต่ละคนต้องมีประวัติที่ซับซ้อน ไม่ใช่แค่คนธรรมดาที่มีแรงจูงใจเดียว
2. **การเชื่อมโยงข้ามเวลา**: เหตุการณ์ในอดีตต้องส่งผลต่อการกระทำในปัจจุบัน
3. **ความสมจริงทางวิทยาศาสตร์**: หลักฐานต้องอ้างอิงความรู้ทางวิทยาศาสตร์ที่ถูกต้อง
4. **ความซับซ้อนของแผนการ**: แผนการฆาตกรรมต้องแสดงความชาญฉลาดและการวางแผนมานาน
5. **การหลอกลวงแบบหลายชั้น**: ไม่ใช่แค่การหลอกลวงเดียว แต่มีหลายระดับของการหลอกลวง
6. **การสร้างความประหลาดใจ**: ผู้อ่านต้องประหลาดใจกับตัวฆาตกรและวิธีการ แต่เมื่อทราบแล้วต้องสมเหตุสมผล
7. **การใช้จิตวิทยาอาญา**: การวิเคราะห์พฤติกรรมและแรงจูงใจของผู้กระทำผิด
