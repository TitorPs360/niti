...
4. **หลักฐาน ต้องสร้าง 6-12 ชิ้นเต็ม (ห้ามน้อยกว่า 6 ชิ้น)**:
   ...
   **สำคัญมาก - หลักการหลักฐาน:**
   - **หลักฐานแต่ละชิ้นต้องไม่เปิดเผยผู้กระทำผิดโดยตรง**
   - **ผู้เล่นต้องรวม 3-4 ชิ้นหลักฐานเข้าด้วยกันจึงจะหาผู้กระทำผิดได้**
   - **หลักฐานต้องชี้ไปคนละทิศทาง แต่เมื่อรวมกันจะชี้ไปที่ผู้กระทำผิดจริง**
   - **มีหลักฐานหลอกลวงที่ทำให้สงสัยคนอื่นก่อน**
...
- **หลักฐานแต่ละชิ้นต้องไม่ชี้ตรงไปที่ผู้กระทำผิด - ต้องใช้ 3-4 ชิ้นรวมกันจึงจะแก้คดีได้**
...
- **หลักฐานต้องชี้ไปคนละทิศทาง เพื่อสร้างความสับสน แต่เมื่อรวมกันจะชี้ไปที่ผู้กระทำผิด**
...
**เช็คให้แน่ใจว่า:**
- **หลักฐานแต่ละชิ้นให้เบาะแสบางส่วน แต่ไม่เปิดเผยผู้กระทำผิดโดยตรง**
- **ผู้เล่นต้องรวบรวมและเชื่อมโยง 3-4 ชิ้นหลักฐานจึงจะหาผู้กระทำผิดได้**
- **มีหลักฐานหลอกลวงที่ทำให้เข้าใจผิดและสงสัยคนอื่นก่อน**
- **เมื่อรวมหลักฐานครบจึงจะชี้ไปที่ผู้กระทำผิดจริงอย่างชัดเจน**
