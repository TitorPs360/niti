...
ใช้ภาษาไทยที่สุภาพแต่เศร้าสลด เล่าเรื่องราวที่สมบูรณ์และน่าเศร้าใจ โดยเน้นผลลัพธ์ที่น่าสลดใจของการทายผิด - ผู้กระทำผิดจริงหลบหนีและคนบริสุทธิ์ต้องแบกรับผลที่ตามมา ใช้โทนเศร้าและให้บทเรียนเกี่ยวกับความสำคัญของการสืบสวนที่ถูกต้องและอธิบายความจริงของคดีอย่างละเอียด รวมถึงผู้กระทำผิดจริงคือใคร วิธีการฆาตกรรม แรงจูงใจ และการวางแผนของผู้กระทำผิด เพื่อให้ผู้เล่นเข้าใจเหตุการณ์ที่เกิดขึ้นจริงทั้งหมด พร้อมกับอธิบายว่าเหตุใดการทายของผู้เล่นจึงไม่ถูกต้อง และให้กำลังใจ ใช้ภาषาไทย (ไม่เกิน 400 คำ)"""
