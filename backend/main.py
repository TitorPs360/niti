...
ผู้เล่นทายถูกต้อง! โปรดให้คำตัดสินที่ชื่นชมและอธิบายเรื่องราวความจริงของคดีอย่างละเอียด รวมถึงวิธีการฆาตกรรม แรงจูงใจ และการวางแผนของผู้กระทำผิด เพื่อให้ผู้เล่นเข้าใจเหตุการณ์ที่เกิดขึ้นจริงทั้งหมด ใช้ภาษาไทยที่สุภาพ (ไม่เกิน 300 คำ)"""
    else:
...
ผู้เล่นทายผิด โปรดให้คำตัดสินที่สุภาพและอธิบายความจริงของคดีอย่างละเอียด รวมถึงผู้กระทำผิดจริงคือใคร วิธีการฆาตกรรม แรงจูงใจ และการวางแผนของผู้กระทำผิด เพื่อให้ผู้เล่นเข้าใจเหตุการณ์ที่เกิดขึ้นจริงทั้งหมด พร้อมกับอธิบายว่าเหตุใดการทายของผู้เล่นจึงไม่ถูกต้อง และให้กำลังใจ ใช้ภาषาไทย (ไม่เกิน 300 คำ)"""
